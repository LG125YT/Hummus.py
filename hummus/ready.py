...
class Ready:
    def __init__(self, data: dict[str, typing.Any], instance):
        ...
        self.shard: list[int] | None = data.get('shard')
...
class Self(User):
    def __init__(self, data, instance):
        ...
        self.email: str | None = data['email']
        self.verified: bool = data['verified']
        self.flags: int = data.get('flags')
        self.mfa_enabled: bool = data.get('mfa_enabled')
        self.premium: bool = data['premium']
        self.token: str | None = data.get('token')  # PATCH /users/@me returns this
